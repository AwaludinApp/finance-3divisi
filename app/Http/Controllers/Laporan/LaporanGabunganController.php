...
class LaporanGabunganController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $buku_besar = BukuBesar::selectRaw('tanggal_transaksi,akun_id,pemasukan,pengeluaran,keterangan')
            ->where('is_deleted', 0)
        ...
        $second = Second::selectRaw('tanggal_transaksi,akun_id,pemasukan,pengeluaran,keterangan')
            ->where('is_deleted', 0)
            ->where(function($q) use ($akun_id, $start, $end){
        ...
        $gabungan = BukuKecil::selectRaw('tanggal_transaksi,akun_id,pemasukan,pengeluaran,keterangan')
            ->where('is_deleted', 0)
            ->where(function($q) use ($akun_id, $start, $end){
        ...
        return view('pages.laporan.gabungan', compact('title', 'gabungan', 'queries', 'akuns', 'start', 'end', 'info_akun', 'akun_id'));
    }
    ...
    public function export_pdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('pages.laporan.pdf.gabungan', compact('title', 'gabungan', 'akuns', 
            'start', 'end', 'info_akun', 'queries', 'jenis_kas', 'queries', 'akun_id'));

        return $pdf->download("laporan-keuangan-semua-kas-" . date('dmY-Hi') . '.pdf');
