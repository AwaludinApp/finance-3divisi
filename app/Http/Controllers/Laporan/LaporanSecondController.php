...
class LaporanSecondController extends Controller
{
    //
    public function index(Request $request)
    {
        ...
        return view('pages.laporan.second', compact('title', 'second', 
    ...
    public function export_pdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('pages.laporan.pdf.second', compact('title', 'second', 'akuns', 
            'start', 'end', 'info_akun', 'queries', 'jenis_kas', 'queries', 'akun_id'));

        return $pdf->download("laporan-keuangan-second-" . date('dmY-Hi') . ".pdf");
    }
}
